...
import AgentTrapHardening from './pages/AgentTrapHardening';
import ManagedAgentArchitecture from './pages/ManagedAgentArchitecture';
import BusinessOutcomeFinOps from './pages/BusinessOutcomeFinOps';
...
export default function App() {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case 'integrations':
        return <Integrations />;
      case 'agent-trap-hardening':
        return <AgentTrapHardening />;
      case 'managed-agent-architecture':
        return <ManagedAgentArchitecture />;
      case 'business-outcome-finops':
        return <BusinessOutcomeFinOps />;
      default:
        return <Dashboard />;
    }
  };
